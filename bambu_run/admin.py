...
class FilamentAdmin(admin.ModelAdmin):
    list_display = (
        ...
        'is_loaded_in_ams', 'is_loaded_externally', 'current_printer', 'current_tray_id', 'last_used'
    )
    list_filter = ('type', 'brand', 'is_loaded_in_ams', 'is_loaded_externally', 'current_printer')
    ...
    fieldsets = (
        ...
        ('Current Status', {
            'fields': ('remaining_percent', 'remaining_weight_grams',
                       'is_loaded_in_ams', 'is_loaded_externally', 'current_printer', 'current_tray_id',
